...
from xmodule.modulestore import ModuleStoreEnum, split_migrator, compute_location_from_args
...
class MixedModuleStore(ModuleStoreWriteBase):
    ...
    def create_course(self, org, offering, user_id, fields=None, **kwargs):
        ...
        return store.create_course(org, offering, user_id, fields=fields, **kwargs)
