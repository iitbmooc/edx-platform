...
class TestItemCrud(SplitModuleTest):
    ...
    def test_create_continue_version(self):
        ...
        new_course = modulestore().create_course('test_org', 'test_transaction', user, BRANCH_NAME_DRAFT)
    ...
    def create_course_for_deletion(self):
        ...
        """
        course = modulestore().create_course('nihilx', 'deletion', 'deleting_user', BRANCH_NAME_DRAFT)
...
class TestCourseCreation(SplitModuleTest):
    ...
    def test_simple_creation(self):
        ...
        new_course = modulestore().create_course('test_org', 'test_course', 'create_user', BRANCH_NAME_DRAFT)
    ...
    def test_cloned_course(self):
        ...
        new_draft = modulestore().create_course(
            'best', 'leech', 'leech_master', BRANCH_NAME_DRAFT,
    ...
    def test_derived_course(self):
        ...
        new_draft = modulestore().create_course(
            'counter', 'leech', 'leech_master', BRANCH_NAME_DRAFT,
    ...
    def test_create_with_root(self):
        ...
        new_course = modulestore().create_course(
            'test_org', 'test_transaction', user, BRANCH_NAME_DRAFT,
    ...
    def test_create_id_dupe(self):
        ...
        with self.assertRaises(DuplicateCourseError):
            ...
            modulestore().create_course(dupe_course_key.org, dupe_course_key.offering, user, BRANCH_NAME_DRAFT)
